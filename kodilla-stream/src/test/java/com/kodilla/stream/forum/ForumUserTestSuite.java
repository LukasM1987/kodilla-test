...
public class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriends() {
        ...
        //Then
        Assertions.assertEquals(3, user1.getLocationOfFriends().size());
        Assertions.assertTrue(user1.getLocationOfFriends().contains("Key West"));
        Assertions.assertTrue(user1.getLocationOfFriends().contains("Washington"));
        Assertions.assertTrue(user1.getLocationOfFriends().contains("Miami"));
        Assertions.assertFalse(user1.getLocationOfFriends().contains("Orlando"));
    }
