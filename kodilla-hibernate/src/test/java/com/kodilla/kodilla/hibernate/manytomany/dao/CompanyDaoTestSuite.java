...
import com.kodilla.kodilla.hibernate.manytomany.facade.CompanyAndEmployeeFacade;
import com.kodilla.kodilla.hibernate.manytomany.facade.FacadeException;
...
class CompanyDaoTestSuite {
    ...
    void findByLastnameTest() {
        ...
        assertNotEquals("Smith", employees.get(0).getLastname());
    ...
    void findByThreeSingsTest() {
        ...
        //When
        List<Company> companies = companyDao.findByThreeFirstSigns("Dat");
    ...
    void facadeTestSuite() {
        ...
        try {
            companyAndEmployeeFacade.companyFacade("Mae");
        } catch (FacadeException e) {

        }

        try {
            companyAndEmployeeFacade.employeeFacade("arc");
        } catch (FacadeException e) {
